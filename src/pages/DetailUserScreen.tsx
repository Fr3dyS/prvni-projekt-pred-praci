...
export default function DetailUserScreen() {
    ...
    const [detailUser, setUser] = useState<User>();
                                ...
                                <div className="max-w-2xl mx-auto">
                                    <div className="bg-white shadow-lg rounded-lg overflow-hidden">
                                        <div className="px-6 py-4">
                                            <div className="flex items-center">
                                                ...
                                                <div className="ml-4">
                                                    ...
                                                    <p className="text-gray-600">{detailUser.username}</p>
                                                </div>
                                            </div>
                                            <div className="mt-6">
                                                <dl className="grid grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-2">
                                                    <div className="sm:col-span-1">
                                                        ...
                                                        <dd className="mt-1 text-lg font-medium text-gray-900">{detailUser.firstName}</dd>
                                                    </div>
                                                    <div className="sm:col-span-1">
                                                        <dt className="text-sm font-medium text-gray-500">Last Name</dt>
                                                        <dd className="mt-1 text-lg font-medium text-gray-900">{detailUser.lastName}</dd>
                                                    </div>
                                                    <div className="sm:col-span-1">
                                                        <dt className="text-sm font-medium text-gray-500">User ID</dt>
                                                        <dd className="mt-1 text-lg font-medium text-gray-900">{detailUser.id}</dd>
                                                    </div>
                                                    <div className="sm:col-span-1">
                                                        <dt className="text-sm font-medium text-gray-500">Role</dt>
                                                        <dd className="mt-1 text-lg font-medium text-gray-900">{detailUser.role}</dd>
                                                    </div>
                                                </dl>
                                            </div>
                                        </div>
                                        ...
                                        <div className="flex justify-between mt-6">
                                            {user?.role === 'admin' || user?.role === 'manager' || user?.username === detailUser.username ? (
                                                <>
